...
const I18N = {
  ...
  zh: {
    ...
    report: {
      ...
      payslip_d: '含 EPF/SOCSO/EIS/PCB 法定扣除明细', epf_borang_a_d: '月度公积金缴款表 (KWSP 6)', ea_form_d: '年度个人薪酬扣税表 · Part A~F', ea_pdf: '官方PDF版',
      cp39: 'CP39 · PCB月报', socso_8a: 'SOCSO Form 8A', bank_ibg: '银行文件 IBG', payroll_gl: '薪资凭证分类账', lhdn_audit: 'LHDN 审计文件',
      cp39_d: '月度预扣税汇缴表 (LHDN)', socso_8a_d: '社保月度缴款表 (PERKESO)', bank_ibg_d: '批量出粮定长文件 (.txt)', payroll_gl_d: '借贷平衡会计凭证', lhdn_audit_d: '税务审计存档 (.txt)',
  ...
  en: {
    ...
    report: {
      ...
      payslip_d: 'With EPF/SOCSO/EIS/PCB statutory deductions', epf_borang_a_d: 'Monthly EPF contribution (KWSP 6)', ea_form_d: 'Annual remuneration statement · Part A~F', ea_pdf: 'Official PDF',
      cp39: 'CP39 · PCB Monthly', socso_8a: 'SOCSO Form 8A', bank_ibg: 'Bank File IBG', payroll_gl: 'Payroll GL Journal', lhdn_audit: 'LHDN Audit File',
      cp39_d: 'Monthly MTD/PCB remittance (LHDN)', socso_8a_d: 'Monthly SOCSO contribution (PERKESO)', bank_ibg_d: 'Fixed-length batch payout (.txt)', payroll_gl_d: 'Balanced accounting journal', lhdn_audit_d: 'Tax audit archive (.txt)',
